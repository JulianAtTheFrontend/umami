...
import type { ActiveTimeData } from '../getWebsiteActiveTime';

const FUNCTION_NAME = 'getSessionActiveTime';

export async function getSessionActiveTime(
...
async function clickhouseQuery(websiteId: string, sessionId: string) {
  ...
  return rawQuery(
    ...
    where event_data.website_id = {websiteId:UUID}
      and event_data.session_id = {sessionId:UUID}
